function [Tx_west, Ty_west, Tx_north, Ty_north] = optimize_registrations(source_directory, img_name_grid,Tx_west, Ty_west,Tx_north, Ty_north,...
    nb_vert_tiles,nb_horz_tiles,valid_translations_west,valid_translations_north)
...
r = 2*max(r, 1) + 1;
fprintf('Overall translation Repeatability: %d\n', r);
