function   mainn = global_registration_SPT(Tx_west, Ty_west, Tx_north, Ty_north,...
    weight_north,weight_west, nb_vert_tiles,nb_horz_tiles,...
    source_directory, img_name_grid, channel, Optimization,dataset_name, time_pairwise);
mainn.time_pairwise = time_pairwise;
tic
[mainn.tiling_indicator, mainn.tile_weights, mainn.global_y_img_pos, mainn.global_x_img_pos] = shortest_path_spanning_tree(Ty_north, Tx_north, Ty_west, Tx_west, weight_north, weight_west);

mainn.time_spannig_tree = toc;
tic
...
mainn.total_time =mainn.time_pairwise + mainn.time_spannig_tree;
tic
imwrite(I,sprintf('%s_stitching_result_Optimization_%s_SPT.jpg',dataset_name,Optimization))
