function   mainn = global_registration_MST(Tx_west, Ty_west, Tx_north, Ty_north,...
...
tic
imwrite(I,sprintf('%s_stitching_result_Optimization_%s_MST.jpg',dataset_name,Optimization))
