...
function [tiling_indicator, tiling_coeff, global_y_img_pos, global_x_img_pos] = minimum_spanning_tree_customized(Y1, X1, Y2, X2, CC1, CC2)
...
[tiling_indicator, global_y_img_pos, global_x_img_pos, tiling_coeff] = minimum_spanning_tree_worker(tiling_indicator, global_y_img_pos, global_x_img_pos, ...
    Y1, X1, Y2, X2, CC1, CC2 ,val); 

% tiling_coeff = 1./tiling_coeff;
...
function [tiling_indicator, global_y_img_pos, global_x_img_pos, tiling_coeff] = minimum_spanning_tree_worker(tiling_indicator, global_y_img_pos, global_x_img_pos, Y1, X1, Y2, X2, CC1, CC2,val)
